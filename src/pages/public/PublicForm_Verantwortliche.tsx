...
const PROXY_BASE = '';
const APP_ID = '6a293dfacd0fac970e8ed88d';
...
export default function PublicFormVerantwortliche() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Verantwortliche — Formular</h1>
        </div>
