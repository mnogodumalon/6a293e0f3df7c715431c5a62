...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    ...
    'enddatum': { kind: 'todayOffset', days: 1, withTime: true },
    'status': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
    'prioritaet': { kind: 'lookup', key: 'mittel', label: 'Mittel' },
  },
  computed: {
    '_veranstaltung_dauer_stunden': { kind: 'dateDiff', from: 'startdatum', to: 'enddatum', unit: 'hours' },
  },
};
